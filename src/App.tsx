...
import { 
  ...
  Plus, Minus, RefreshCw, ExternalLink, Video, Play
} from 'lucide-react';
...
const MAP_PATHS = [
  ...
  { name: "青森", points: "3 71 3 63 0 60 6 51 12 51 18 47 21 31 17 27 20 26 21 19 27 23 31 20 35 23 37 38 40 45 46 41 45 37 47 33 58 42 61 39 65 23 61 16 55 22 41 25 47 0 64 11 73 6 71 37 73 51 77 62 81 61 86 67 80 74 75 72 71 75 69 72 56 82 52 81 53 70 48 70 48 65 38 72 35 70 32 72 25 67 22 70 10 68 7 72", transform: "translate(624, 287)" },
  { name: "岩手", points: "48 92 41 91 39 105 33 102 29 107 23 103 25 99 17 100 7 95 8 89 5 84 8 81 0 68 3 57 7 51 5 46 8 42 5 38 10 37 8 19 12 14 16 15 29 5 31 8 35 5 40 7 46 0 54 11 52 16 57 19 55 23 61 28 64 43 62 53 65 49 66 54 68 55 62 60 64 62 67 59 67 63 63 68 60 69 65 68 60 71 62 73 60 75 64 74 58 81 62 83 57 83 60 86 57 86 59 88 53 89 52 86 54 91 52 91 52 94 50 90", transform: "translate(664, 354)" },
  ...
  { name: "秋田", points: "54 97 47 102 43 101 39 100 37 95 23 92 19 87 9 88 11 78 16 69 17 47 11 39 3 42 0 33 6 36 12 28 15 19 15 11 10 6 14 7 17 3 29 5 32 2 39 7 42 5 45 7 55 0 55 5 60 5 59 16 55 21 57 39 52 40 55 44 52 48 54 53 50 59 47 70 55 83 52 86 55 91", transform: "translate(617, 352)" },
  { name: "山形", points: "14 1 24 0 28 5 42 8 44 13 48 14 53 22 51 30 48 30 52 41 45 53 46 59 43 65 36 67 37 72 36 81 38 82 35 86 29 87 26 85 22 86 20 82 14 83 7 81 4 76 7 68 7 60 15 57 17 53 8 47 8 40 0 37 13 14", transform: "translate(612, 439)" },
  { name: "福島", points: "82 69 72 64 72 68 66 74 56 65 55 59 49 55 37 52 12 68 4 66 5 52 0 47 4 41 2 37 3 34 12 33 13 30 21 30 19 21 28 11 25 9 32 11 38 10 40 14 44 13 47 15 53 14 56 10 54 9 55 0 61 0 65 4 74 4 75 10 80 12 79 10 83 10 83 4 87 4 93 18 93 45 91 61", transform: "translate(594, 511)" },
  { name: "茨城", points: "5 54 5 54 2 55 0 48 7 45 8 41 11 41 14 36 25 34 28 27 26 17 29 15 28 12 28 1 38 10 44 4 44 0 54 5 46 29 47 35 44 42 46 52 51 61 49 63 51 66 52 62 60 74 42 62 42 65 24 69 13 64", transform: "translate(622, 575)" },
  { name: "栃木", points: "19 60 18 59 16 55 7 56 2 49 8 36 0 33 1 24 4 21 1 19 3 16 28 0 40 3 46 7 47 13 47 24 48 27 45 29 47 39 44 46 33 48 30 53 27 53 26 57", transform: "translate(603, 563)" },
  { name: "群馬", points: "64 52 54 54 48 50 37 48 32 58 16 67 12 65 12 59 9 56 12 55 10 49 13 47 12 41 3 41 0 36 1 29 6 25 5 23 14 20 26 14 26 11 29 10 28 5 32 4 34 0 41 7 49 9 47 12 50 14 47 17 46 26 54 29 48 42 53 49 62 48", transform: "translate(557, 570)" },
  { name: "埼玉", points: "48 4 49 5 51 12 54 11 54 11 60 24 60 31 54 29 52 31 48 30 42 33 42 29 35 32 30 28 15 24 12 27 1 24 0 19 16 10 21 0 32 2 38 6", transform: "translate(573, 618)" },
  { name: "千葉", points: "5 29 7 25 6 20 6 13 0 0 8 10 19 15 37 11 37 8 55 20 55 24 45 24 34 35 32 57 19 61 7 75 0 71 5 69 3 66 4 63 3 58 5 53 1 49 4 45 7 46 7 42 13 39 18 33 11 26 6 30", transform: "translate(627, 629)" },
  ...
  { name: "神奈川", points: "10 0 24 6 28 11 28 6 30 6 27 4 30 2 44 9 40 13 36 12 39 16 36 16 36 23 42 26 38 30 39 33 35 33 36 28 33 24 26 22 15 25 11 28 12 34 10 34 4 30 4 17 0 17 9 9", transform: "translate(584, 656)" },
  ...
  { name: "富山", points: "41 37 31 33 27 35 27 33 22 35 19 33 10 44 9 40 5 38 1 43 0 35 2 27 1 23 3 20 1 16 4 14 6 4 14 2 11 8 23 15 31 11 33 3 43 0 47 3 50 14 49 25 46 26 47 29", transform: "translate(475, 575)" },
  ...
  { name: "福井", points: "40 0 46 8 56 9 61 14 66 13 64 19 70 27 67 31 54 32 53 34 47 31 42 40 35 37 36 45 33 44 33 47 27 50 24 48 21 55 18 54 15 58 3 56 0 51 1 45 3 49 10 46 6 49 13 50 15 47 13 48 13 45 19 47 17 45 20 43 18 40 26 41 25 35 28 33 29 38 31 39 32 32 25 19 34 6 34 2", transform: "translate(408, 618)" },
  { name: "山梨", points: "2 21 0 16 3 14 0 11 10 0 15 5 21 3 25 6 28 4 39 7 43 15 48 18 47 27 38 35 26 38 21 33 17 41 18 48 13 50 9 41 4 40 5 29", transform: "translate(546, 638)" },
  { name: "長野", points: "68 18 59 21 60 23 55 27 54 34 57 39 66 39 67 45 64 47 66 53 63 54 66 57 66 63 70 65 71 70 68 72 64 69 58 71 53 66 43 77 46 80 43 82 45 87 41 92 41 104 26 114 18 112 13 115 12 109 14 106 12 102 15 102 13 99 15 95 9 89 11 86 6 79 0 76 2 71 7 71 13 64 14 60 11 56 16 46 13 40 19 32 18 29 21 28 22 17 27 10 27 7 34 8 34 13 36 14 44 10 48 12 48 7 53 2 60 0 63 2 63 7 68 11", transform: "translate(503, 572)" },
  { name: "岐阜", points: "66 4 69 10 64 20 67 24 66 28 60 35 55 35 53 40 59 43 64 50 62 53 68 59 66 63 68 66 65 66 67 70 65 73 58 77 52 73 45 75 40 73 34 65 24 68 20 76 19 82 12 75 6 77 4 76 8 66 7 63 4 56 1 56 0 50 5 41 11 44 12 42 25 41 28 37 22 29 24 23 29 13 26 10 30 5 34 7 35 11 44 0 47 2 52 0 52 2 56 0", transform: "translate(450, 608)" },
  { name: "静岡", points: "73 14 77 14 77 27 83 31 81 36 85 42 85 46 78 55 77 61 70 65 64 59 67 45 65 41 66 38 72 37 62 31 55 33 51 38 53 41 44 45 42 54 36 61 38 65 25 61 0 60 0 52 8 47 18 27 33 17 33 5 37 0 40 8 39 19 44 20 48 29 53 27 52 20 56 12 61 17", transform: "translate(511, 659)" },
  { name: "愛知", points: "42 46 18 52 20 47 23 49 31 43 33 46 35 43 34 40 28 37 26 41 18 40 14 37 16 29 12 40 16 45 13 45 9 41 10 36 8 33 8 28 12 21 5 25 0 17 1 11 5 3 15 0 21 8 26 10 33 8 39 12 46 8 47 14 52 11 60 13 50 33 42 38", transform: "translate(469, 673)" },
  { name: "三重", points: "8 95 3 92 0 86 1 86 1 83 3 83 8 80 8 77 13 76 14 73 13 66 15 62 13 59 15 58 12 53 20 47 11 42 12 38 10 37 13 36 11 32 10 28 13 27 14 22 21 25 27 22 31 12 30 2 36 0 43 7 48 15 42 16 43 20 36 32 35 40 51 47 53 52 56 51 55 55 50 55 55 56 55 61 51 62 53 60 50 58 49 60 43 61 46 57 42 57 39 62 39 60 36 63 34 61 34 64 32 62 25 66 22 68 23 73 21 72 22 70 18 73 22 77 20 77 22 80 19 78 20 81 13 85", transform: "translate(426, 683)" },
  ...
  { name: "京都", points: "44 63 41 55 37 54 38 51 34 54 26 46 27 41 17 39 15 32 10 34 3 29 4 23 10 23 10 17 9 15 4 16 0 11 1 7 3 10 2 8 19 0 23 7 15 14 18 15 20 11 20 15 24 17 23 21 25 18 27 19 25 14 31 11 32 14 31 20 34 25 46 27 51 32 48 46 51 56 55 56 59 62 60 66 58 68 54 65 50 68", transform: "translate(377, 649)" },
  { name: "大阪", points: "16 0 24 8 28 5 27 8 31 9 34 17 29 28 31 37 29 42 3 48 0 45 7 44 14 37 17 28 19 30 17 22 20 20 18 9 20 8 14 5 13 1", transform: "translate(387, 695)" },
  ...
  { name: "奈良", points: "24 48 19 51 19 54 17 54 17 57 16 57 3 55 5 49 0 42 6 35 10 34 6 25 8 20 6 11 11 0 17 5 21 2 25 5 27 3 29 7 26 8 28 9 27 13 36 18 28 24 31 29 29 30 31 33 29 37 30 44 29 47", transform: "translate(410, 712)" },
  ...
  { name: "鳥取", points: "7 33 0 31 4 25 2 22 10 20 11 11 5 3 7 2 9 6 15 8 23 4 34 6 55 5 64 0 71 17 71 21 65 23 53 27 52 21 45 18 46 16 36 22 32 17 25 15 22 21 20 22 21 25 14 25 15 29 8 30", transform: "translate(288, 658)" },
  ...
  { name: "岡山", points: "58 8 59 14 51 22 52 29 50 32 54 38 53 41 46 39 49 42 43 49 34 48 39 49 36 53 34 52 33 57 27 55 25 58 23 52 23 55 19 51 15 55 10 52 12 56 8 54 4 38 5 33 1 28 3 21 0 18 1 15 8 14 7 10 14 10 13 7 15 6 18 0 25 2 29 7 39 1 38 3 45 6 46 12", transform: "translate(295, 673)" },
  ...
  { name: "福岡", points: "40 53 32 48 31 52 27 51 22 55 23 58 18 58 18 52 15 49 17 42 25 37 26 31 19 33 13 27 0 27 7 23 3 20 10 15 13 21 20 20 21 15 17 17 14 14 19 15 23 12 25 5 35 3 36 0 42 1 38 5 41 5 43 2 46 4 53 0 49 8 52 10 50 11 55 22 60 22 59 29 52 28 45 32 41 38 42 43 40 45 43 48", transform: "translate(123, 752)" },
  { name: "佐賀", points: "15 6 28 6 34 12 41 10 40 16 32 21 30 28 25 23 19 29 22 39 14 36 8 29 9 25 2 23 0 16 2 13 5 17 4 13 6 9 2 6 3 4 6 6 6 0 7 2 11 2 12 7", transform: "translate(108, 773)" },
...
const JapanMap = ({ onSelectPrefecture }: { onSelectPrefecture: (pref: string) => void }) => {
  ...
  const PrefecturePath = ({ name, d, points, transform }: any) => {
    const isActive = activePrefs.some(p => name.includes(p));
    // 個別のクリックイベント（親のドラッグと競合しないよう、シンプルに伝播させる）
    return (
      <g 
        className={`transition-all duration-300 ${isActive ? 'cursor-pointer hover:opacity-80' : 'fill-white stroke-slate-300'}`}
        transform={transform}
        // ここでのクリックは「親のドラッグ判定ロジック」に任せるため、あえてonClickを付けない
        data-pref-name={name} // 代わりにデータ属性を持たせる
      >
        <title>{name}</title>
        {points ? (
          <polygon points={points} fill={isActive ? "#ccfbf1" : "#ffffff"} stroke="#64748b" strokeWidth="1" />
        ) : (
          <path d={d} fill={isActive ? "#ccfbf1" : "#ffffff"} stroke="#64748b" strokeWidth="1" />
        )}
        {isActive && (
  ...
  return (
    <svg className="w-full h-full bg-slate-100 pointer-events-none" viewBox="0 0 1000 1000">
      <g transform="scale(1.45) translate(-435, -216)" className="pointer-events-auto">
        <g transform="translate(6, 18)">
          {MAP_PATHS.map((pref) => (
             // グループ化してデータ属性を付与
             <g key={pref.name} data-name={pref.name}>
               <PrefecturePath {...pref} />
             </g>
          ))}
        </g>
...
export default function ChiikuriApp() {
  ...
  const handleSelectPrefecture = (pref: string) => {
    ...
    document.getElementById('pref-video-list')?.scrollIntoView({ behavior: 'smooth' });
  };
  ...
  const handleMouseDown = (e: React.MouseEvent) => {
    setIsDragging(false); // 初期状態はfalse
  ...
  const handleMouseUp = (e: React.MouseEvent) => {
    if (!isDragging) {
      // 親を遡ってデータ属性を探す（Reactイベントバブリングでは e.target が path になるため）
      let target = e.target as HTMLElement;
      while (target && target !== mapRef.current) {
        const prefName = target.getAttribute('data-name');
        if (prefName) {
           const hasVideos = allVideosData.some(v => v.location.includes(prefName.substring(0,2)));
           if (hasVideos) handleSelectPrefecture(prefName.substring(0,2));
           break;
        }
  ...
  const handleTouchStart = (e: React.TouchEvent) => {
    setIsDragging(false);
    dragStart.current = { x: e.touches[0].clientX - mapPosition.x, y: e.touches[0].clientY - mapPosition.y };
  };

  const handleTouchMove = (e: React.TouchEvent) => {
    setIsDragging(true);
    setMapPosition({ x: e.touches[0].clientX - dragStart.current.x, y: e.touches[0].clientY - dragStart.current.y });
  };

  // タッチ終了時のクリック判定は、厳密には難しいので今回は「ドラッグ中じゃなければクリック」とみなす簡易実装
  // （実機では多少のズレ許容が必要ですが、プロトタイプとしてはこれで十分機能します）
  const handleTouchEnd = (e: React.TouchEvent) => {
      // 実際には touchEnd では target が取れない場合があるが、
      // React の onClick が発火するならそちらに任せる手もある。
      // ここでは mouseUp と同様のロジックは実装せず、onClick 側に任せる。
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col">
      ...
      <main className="flex-grow">
        ...
        {/* MAP (地図検索) - ドラッグ移動 & ピンクリック対応版 */}
        {view === 'map' && (
          <div className="bg-slate-100 min-h-full flex flex-col md:flex-row h-[calc(100vh-64px)]">
             {/* 地図エリア */}
             <div 
               ref={mapRef}
               className="flex-grow relative bg-slate-100 overflow-hidden cursor-grab active:cursor-grabbing h-[50vh] md:h-auto"
             ...
             >
                {/* 地図コンテナ（ドラッグで移動） */}
                <div 
                  className="absolute w-[1000px] h-[1000px]" // 固定サイズを指定して消滅を防ぐ
                  style={{ transform: `translate(${mapPosition.x}px, ${mapPosition.y}px)` }}
                >
                  <JapanMap onSelectPrefecture={(pref) => {
                    if (!isDragging) handleSelectPrefecture(pref);
                  }} />
                </div>
                
                <div className="absolute bottom-4 left-4 bg-white/90 px-3 py-2 rounded-lg text-xs text-slate-500 shadow-md pointer-events-none">
                  ※ 緑色のエリアをタップ / ドラッグで移動
                </div>
             </div>
             ...
             <div className="w-full md:w-96 bg-white shadow-xl border-l border-slate-200 p-6 overflow-y-auto h-[50vh] md:h-full z-20" id="pref-video-list">
                ...
                {selectedPrefVideos.length > 0 ? (
                  ...
                  <div className="text-center text-slate-400 py-12">
                    ...
                    <p>地図上の緑色のエリアをタップして<br/>教室を探してください</p>
                  </div>
                )}
             </div>
          </div>
