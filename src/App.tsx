              ...
              <>
                ...
                <div className="bg-slate-900 text-white animate-in fade-in">
                  <div className="max-w-7xl mx-auto px-4 py-16 md:py-24 text-center space-y-8">
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight bg-gradient-to-r from-emerald-200 to-cyan-200 bg-clip-text text-transparent">地域の「技」と「心」に出会う</h1>
                    ...
                    <section key={cat} className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {allVideosData.filter(v => v.category === cat).map(v => {
                          ...
                          return (
                          <div key={v.id} onClick={() => { setPlayingVideo(v); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="group bg-white rounded-2xl border border-slate-100 overflow-hidden cursor-pointer shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
